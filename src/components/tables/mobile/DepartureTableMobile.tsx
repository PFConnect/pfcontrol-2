              ...
              {departureColumns.callsign !== false && (
                <div>
                  ...
                  <TextInput
                    ...
                    onChange={(value) => handleCallsignChange(flight.id, value)}
              ...
              {departureColumns.runway !== false && (
                <div>
                  ...
                  <RunwayDropdown
                    ...
                    value={flight.runway}
                    onChange={(runway) => handleRunwayChange(flight.id, runway)}
                    size="xs"
                    placeholder="-"
                  />
                </div>
              ...
              {departureColumns.squawk !== false && (
                <div>
                  ...
                  <div className="flex items-center gap-0.5 mt-1">
                    <TextInput
                      value={flight.squawk || ''}
                      onChange={(value) => handleSquawkChange(flight.id, value)}
