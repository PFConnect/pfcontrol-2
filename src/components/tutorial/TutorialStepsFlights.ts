...
export const steps: {
  ...
  },
  {
    ...
    title: 'TIME',
    content: 'Shows when the flight strip was created or submitted (UTC). For reference only.',
    placement: 'top',
    disableNext: true,
  },
  {
  ...
  },
  {
    ...
    title: 'STAND',
    content: 'The parking stand/gate where the aircraft is located. Enter or edit the stand/gate number.',
    placement: 'top',
    disableNext: true,
  },
  {
  ...
  },
  {
    ...
    content: 'Wake Turbulence Category (L/M/H/S). Always auto-filled based on aircraft type but helps with separation.',
    placement: 'top',
    disableNext: true,
  },
  {
    ...
    title: 'V (Flight Type)',
    content: 'Indicates if the pilot filed IFR (Instrument Flight Rules) or VFR (Visual Flight Rules).',
    placement: 'top',
    disableNext: true,
  },
  {
  ...
  },
  {
    ...
    title: 'RWY (Runway)',
    content: 'Departure runway assigned to the flight. Select or edit as needed.',
    placement: 'top',
    disableNext: true,
  },
  {
    ...
    title: 'SID',
    content: 'Standard Instrument Departure procedure. Select or edit if applicable.',
    placement: 'top',
    disableNext: true,
  },
  {
    ...
    content: 'Requested Flight Level (cruising altitude). Enter or edit as needed.',
    placement: 'top',
    disableNext: true,
  },
  {
    ...
    content: 'Cleared altitude assigned by ATC. Update when further climb instructions are given.',
    placement: 'top',
    disableNext: true,
  },
  {
    ...
    title: 'ASSR (Squawk)',
    content: 'Assigned transponder code (4 digits). Enter or edit as needed.',
    placement: 'top',
    disableNext: true,
  },
  {
    ...
    title: 'C (Clearance)',
    content: 'Indicates if the flight has been cleared for departure (IFR Clearance).',
    placement: 'top',
    disableNext: true,
  },
  {
    ...
    title: 'STS (Status)',
    content: 'Current status (e.g., PENDING, TAXI, RWY, DEPA). Update as the flight progresses.',
    placement: 'top',
    disableNext: true,
  },
  {
  ...
  },
  {
    ...
    title: 'PDC',
    content: 'Button to issue a Pre-Departure Clearance (PDC) to the pilot.',
    placement: 'left',
    disableNext: true,
  },
  {
    target: '#departure-table .column-hide',
    title: 'HIDE',
    content: 'Hide the strip from the table (does not delete it). Click to hide/unhide.',
    placement: 'left',
    disableNext: true,
  },
  {
    target: '#departure-table .column-del',
    title: 'DEL (Delete)',
    content: 'Delete the strip from the table. Click to permanently remove the strip.',
    placement: 'left',
    disableNext: true,
  },
  {
    target: '#departure-table .edit-del',
    title: '',
    content: '',
    placement: 'left',
    disableNext: true,
