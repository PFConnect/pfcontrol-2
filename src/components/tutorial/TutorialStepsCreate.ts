...
export const steps: {
  ...
  },
  {
    ...
    content: 'Optionally set a different runway for arrivals. If not selected, the departure runway will be used for both.',
    placement: 'right' as Placement,
    disableNext: true,
  },
  {
    ...
    title: 'PFATC Network',
    content: 'Check this if you\'re controlling on the PFATC Network. This makes your session publicly visible.',
  ...
  },
  {
    ...
    content: 'Click here to create your session and start controlling! You\'ll be taken to the flight management page.',
    placement: 'top' as Placement,
    disableNext: true,
    isLast: true,
  },
