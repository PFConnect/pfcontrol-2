							...
							<div className="flex items-start mb-4">
								...
								<div className="flex-1">
									...
									<p className="text-zinc-400 text-sm">
										Show both departure and arrival tables
										on the same page for desktop users
									</p>
								</div>
							</div>
						...
						<div className="bg-zinc-800/30 border border-zinc-700/50 rounded-xl p-5">
							<div className="flex items-start mb-4">
								...
								<div>
									...
									<p className="text-zinc-400 text-sm">
										Adjust the opacity of flight strips when
						...
						<div className="flex items-start">
							...
							<div>
								...
								<p className="text-blue-200/80 text-xs sm:text-sm leading-relaxed">
									Combined view only applies to desktop
									screens - mobile devices will always show
									tabs. Flight row transparency affects the
									visibility of flight strips when background
									images are enabled, helping you balance
