...
export const getChartsForAirport = (icao: string) => {
    const charts: { name: string; path: string; type: string; credits?: string; procedures?: string[] }[] = [];
    const baseUrl = '/assets/app/charts';

    const availableCharts: Record<string, { file: string; name: string; type: string; credits?: string; procedures?: string[] }[]> = {
        EFKT: [
            { file: 'EFKT_GND_1.png', name: 'Airport Diagram', type: 'Ground', credits: '© PFATC' },
            { file: 'EFKT_DEP_1.png', name: 'Departure', type: 'Departure', credits: '© PFATC', procedures: ['SPECA1A', 'KEFT2D','ROSE3C','SPECA', 'KEFT', 'ROSE', 'RWY34']},
            { file: 'EFKT_ARR_1.png', name: 'Arrival', type: 'Arrival', credits: '© PFATC', procedures: ['KRDSH1A', 'KIT2D','KEFLA3C','KRDSH', 'KIT', 'KEFLA', 'RWY34']},
        ],
        EGHI: [
        ...
        EGKK: [
            ...
            { file: 'EGKK_DEP_1.jpg', name: 'SID Chart 1', type: 'Departure', credits: '© PFATC', procedures: ['BOGN1X', 'BOGNA', 'RWY26L']},
            { file: 'EGKK_DEP_2.jpg', name: 'SID Chart 2', type: 'Departure', credits: '© PFATC', procedures: ['NOVM1X', 'NOVMA', 'RWY26L']},
            { file: 'EGKK_DEP_3.jpg', name: 'SID Chart 3', type: 'Departure', credits: '© PFATC', procedures: ['WIZA1X', 'WIZAD', 'RWY26L']},
            { file: 'EGKK_ARR_1.jpg', name: 'STAR Chart 1', type: 'Arrival', credits: '© PFATC', procedures: ['KUNA1G', 'KUNAV', 'RWY26L', 'RWY08R']},
            { file: 'EGKK_ARR_2.jpg', name: 'STAR Chart 2', type: 'Arrival', credits: '© PFATC', procedures: ['VASU1G', 'VASUX', 'RWY26L', 'RWY08R']},
        ],
        GCLP: [
            { file: 'GCLP_GND_1.jpg', name: 'Airport Diagram', type: 'Ground', credits: '© BABAXSON' },
            { file: 'GCLP_DEP_1.jpg', name: 'SID Chart 1', type: 'Departure', credits: '© PFATC', procedures: ['KOPU1B', 'KOPU1A', 'KOPUD', 'RWY03L', 'RWY03R', 'RWY21L', 'RWY21R']},
            { file: 'GCLP_DEP_2.jpg', name: 'SID Chart 2', type: 'Departure', credits: '© PFATC', procedures: ['COST4A', 'COST4B', 'COSTI', 'RWY03L', 'RWY03R', 'RWY21L', 'RWY21R']},
            { file: 'GCLP_DEP_3.jpg', name: 'SID Chart 3', type: 'Departure', credits: '© PFATC', procedures: ['OEDG2A', 'OEDG2B', 'ODEGI', 'RWY03L', 'RWY03R', 'RWY21L', 'RWY21R']},
            { file: 'GCLP_ARR_1.jpg', name: 'STAR Chart 1', type: 'Arrival', credits: '© PFATC', procedures: ['LORP1C', 'LORP1Z', 'LORPO', 'RWY03L', 'RWY03R', 'RWY21L', 'RWY21R']},
            { file: 'GCLP_ARR_2.jpg', name: 'STAR Chart 2', type: 'Arrival', credits: '© PFATC', procedures: ['ORTI5C', 'KONBA4B', 'ORTIS', 'KONBA', 'RWY03L', 'RWY03R', 'RWY21L', 'RWY21R']},
            { file: 'GCLP_ARR_3.jpg', name: 'STAR Chart 3', type: 'Arrival', credits: '© PFATC', procedures: ['COST1C', 'COSTI', 'RWY03L', 'RWY03R', 'RWY21L', 'RWY21R']},
        ],
        LCLK: [
        ...
        LEMH: [
            ...
            { file: 'LEMH_DEP_1.png', name: 'Departure', type: 'Departure', credits: '© PFATC', procedures: ['ISKAL1A', 'AVI4D', 'SARGO2B', 'MEROS3C', 'RWY01']},
            { file: 'LEMH_ARR_1.png', name: 'Arrival', type: 'Arrival', credits: '© PFATC', procedures: ['RWY01']},
        ],
        MDAB: [
        ...
        MDPC: [
            ...
            { file: 'MDPC_DEP_1.png', name: 'SID Chart 1', type: 'Departure', credits: '© .hykka', procedures: ['KATO3T', 'CHUM3T', 'PIXA3T', 'ETBO3T' , 'KATOK', 'CHUMA','PIXAR', 'ETBOD', 'RWY26', 'RWY27']},
            { file: 'MDPC_DEP_2.png', name: 'SID Chart 2', type: 'Departure', credits: '© .hykka', procedures: ['KATO2T', 'CHUM3T', 'PIXA3T', 'ETBO3T' , 'KATOK', 'CHUMA','PIXAR', 'ETBOD', 'RWY08', 'RWY09']},
            { file: 'MDPC_ARR_1.png', name: 'STAR Chart 1', type: 'Arrival', credits: '© .hykka', procedures: ['POKE1W', 'BETI1W', 'KATO1W', 'ANTE1W' , 'POKEG', 'BETIR','KATOK', 'ANTEX','RWY08', 'RWY09']},
            { file: 'MDPC_ARR_2.png', name: 'STAR Chart 2', type: 'Arrival', credits: '© .hykka', procedures: ['POKE2C', 'BETI2C', 'KATO2C', 'ANTE2C' , 'POKEG', 'BETIR','KATOK', 'ANTEX', 'RWY27']},
            { file: 'MDPC_ARR_3.png', name: 'STAR Chart 3', type: 'Arrival', credits: '© .hykka', procedures: ['POKE1C', 'BETI1C', 'KATO1C', 'ANTE1C' , 'POKEG', 'BETIR','KATOK', 'ANTEX', 'RWY26'] },
        ],
        MDST: [
