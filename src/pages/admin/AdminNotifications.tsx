...
import { Bell, Plus, Edit, Trash2, Check, X, Eye } from 'lucide-react';
					...
					<div className="mb-8">
						<div className="flex items-center justify-between mb-4">
							<div className="flex items-center">
								...
								<h1
									className="text-5xl text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-cyan-600 font-extrabold"
