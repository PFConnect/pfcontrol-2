							...
							<div className="flex flex-col md:flex-row gap-4">
								...
								<div className="flex-1 relative group">
									...
									<input
										...
										className="w-full pl-11 pr-4 py-3 bg-zinc-900/50 border-2 border-zinc-700 rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-500 transition-all duration-200 hover:border-zinc-600"
									/>
								</div>
