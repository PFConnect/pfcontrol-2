            ...
            <div className="absolute bottom-0 left-64 right-0 p-6 md:p-10">
               <h1 className="text-3xl md:text-5xl font-bold text-white">
                  {session.airportIcao ? (
                     ...
                     >
                        <span className="font-mono">{session.airportIcao}</span>{" "}
                        - Submit Flight Plan
                     </h2>
                  ) : (
                     "Submit Flight Plan"
                  ...
                  <div className="bg-green-900/50 p-4 border-b border-green-700 flex items-center">
                     ...
                     <div className="flex-1">
                        ...
                        <p className="text-green-300 text-sm">
                           Your flight plan has been submitted to ATC and is
                           awaiting clearance.
                        </p>
                     </div>
                     <button
                  ...
                  <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        <div className="space-y-4">
                           <div>
                              ...
                              <input
                                 ...
                                 value={form.callsign}
                                 onChange={(e) =>
                                    handleChange("callsign")(e.target.value)
                                 }
                                 required
                           ...
                           <div>
                              ...
                              <input
                                 ...
                                 value={form.stand}
                                 onChange={(e) =>
                                    handleChange("stand")(e.target.value)
                                 }
                                 placeholder="e.g. A12"
                                 className="flex items-center w-full pl-6 p-3 bg-gray-800 border-2 border-blue-600 rounded-full text-white font-semibold focus:outline-none focus:ring-2 focus:ring-blue-600 transition-all"
                              />
                     ...
                     <div className="mt-8">
                        ...
                        <p className="text-xs text-gray-500 text-center mt-4">
                           By clicking "Submit Flight Plan", you agree to our{" "}
                           <a
