...
export default function PublicFlightView() {
    ...
    const phases = useMemo(() => {
        ...
        const normalizePhase = (phase: string | null | undefined): string => {
            ...
            if (lower.includes('gate') || lower.includes('parked'))
                return 'gate';
        ...
        const finalDur = Math.round(
            (finalEnd.getTime() - start.getTime()) / 60000
        );
        if (finalDur >= 1)
            out.push({
                phase: current,
        ...
        <div className="min-h-screen bg-gray-950 text-white">
            ...
            <div className="container mx-auto max-w-6xl px-4 py-8">
                ...
                {phases.length > 0 && (
                    <div className="mb-6">
                        <div className="flex items-center gap-3 mb-4">
                            <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-green-500 flex items-center justify-center text-white font-bold">
                                Φ
                            </div>
                            <h2 className="text-2xl font-bold text-white">
                                Flight Timeline
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex flex-col items-center">
                                                <div
                                                    className={`w-8 h-8 rounded-full ${colors.dot} shadow-lg relative z-10 flex items-center justify-center border-4 border-gray-900`}
                                                >
                                                    <div
                                                ...
                                                <div
                                                    className={`mt-4 text-center min-w-[140px] px-4 py-3 rounded-xl ${colors.bg} border-2 border-gray-700/50 backdrop-blur-sm`}
                                                >
                                                    <h3
