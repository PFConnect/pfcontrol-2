...
export default function Sessions() {
   ...
   const [deleteInProgress, setDeleteInProgress] = useState<string | null>(
      null
   );
                     ...
                     >
                        ...
                        >
                           ...
                           <div className="space-y-2 text-sm text-gray-300">
                              ...
                              <div className="flex items-center">
                                 <Workflow className="h-4 w-4 mr-2 text-gray-500" />
                                 Strips: {session.flightCount}
                              </div>
                           </div>
                        </Link>
                                    ...
                                    {sessions.find(
                                       ...
                                       <div className="mb-4 p-3 bg-yellow-900/20 border border-yellow-600/30 rounded-lg">
                                          ...
                                          <p className="text-sm text-yellow-200">
                                             This session uses old encryption.
                                             Deleting it is recommended for
                                             security.
                                          </p>
                                       </div>
                                    )}
               ...
               <div className="bg-zinc-900 border-2 border-blue-800 rounded-lg max-w-md w-full p-6 animate-fade-in">
                  ...
                  <div className="mb-6">
                     <p className="text-gray-300 mb-4">
                        Change the name for this session. This helps you
                  ...
                  <div className="flex justify-end space-x-3">
                     ...
                     <Button
                        ...
                        disabled={
                           savingName === editingName || !editNameValue.trim()
                        }
